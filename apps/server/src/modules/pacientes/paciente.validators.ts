...
export const alterarStatusPacienteSchema = z.object({
...
export type ListarPacientesInput = z.infer<typeof listarPacientesSchema>;
export type AlterarStatusPacienteInput = z.infer<typeof alterarStatusPacienteSchema>;
